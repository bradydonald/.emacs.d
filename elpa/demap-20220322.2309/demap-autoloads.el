;;; demap-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn &optional MINIMAP-OR-NAME FRAME)" t)
...
(fn &optional MINIMAP-OR-NAME FRAME)" t)
(register-definition-prefixes "demap" '("demap-minimap-"))
...
(fn &optional NAME SHOWING)" t)
(register-definition-prefixes "demap-minimap" '("demap-"))
...
(register-definition-prefixes "demap-modes" '("demap-track-window-mode-update-p-func"))


;;; Generated autoloads from demap-tools.el

(register-definition-prefixes "demap-tools" '("demap--tools-"))

;;; End of scraped data

(provide 'demap-autoloads)
