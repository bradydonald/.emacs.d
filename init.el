...
;; Tangle and load the configuration on startup
(defun tangle-and-load-org-config ()
  "Tangle and load my Org configuration file."
  (when (file-exists-p my-org-config-file)
    (org-babel-load-file my-org-config-file)))

(tangle-and-load-org-config)
