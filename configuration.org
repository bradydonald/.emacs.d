...
#+begin_src emacs-lisp
  ...
  (define-key org-roam-mode-map "C-c n l" 'org-roam)
  (define-key org-roam-mode-map "C-c n f" 'org-roam-find-file)
  (define-key org-roam-mode-map "C-c n j" 'org-roam-jump-to-index)
  (define-key org-roam-mode-map "C-c n b" 'org-roam-switch-to-buffer)
  (define-key org-roam-mode-map "C-c n g" 'org-roam-graph)

  (define-key org-mode-map "C-c n i" 'org-roam-insert)
