...
* Visual Appearance
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (defvar db/variable-width-font "JetBrains Mono"
        "The font to use for variable-pitch (document) text.")

      ;; NOTE: These settings might not be ideal for your machine, tweak them as needed!
      (set-face-attribute 'default nil :font db/fixed-width-font :weight 'light :height 180)
      (set-face-attribute 'fixed-pitch nil :font db/fixed-width-font :weight 'light :height 180)
...
* Theme and Faces
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (set-face-attribute 'default nil :font db/fixed-width-font :weight 'light :height 100)
    (set-face-attribute 'fixed-pitch nil :font db/fixed-width-font :weight 'light :height 100)
    (set-face-attribute 'variable-pitch nil :font db/fixed-width-font :weight 'light :height 1.0)
    ...
    (dolist (face '((org-level-1 . 1.2)
                    ...
                    (org-level-7 . 1.1)
                    (org-level-8 . 1.1)))
      (set-face-attribute (car face) nil :font db/fixed-width-font :weight 'medium :height (cdr face)))

    ;; Make the document title a bit bigger
    (set-face-attribute 'org-document-title nil :font db/fixed-width-font :weight 'bold :height 1.3)
