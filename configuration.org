...
*** Org-roam Capture Templates
    ...
    #+BEGIN_SRC emacs-lisp
      (setq org-roam-capture-templates
            '(("d" "default" plain "%?"
               :if-new (file+head"%(format-time-string \"%Y-%m-%d--%H-%M-%SZ--${slug}\" (current-time) t)"
               "#+title: ${title}\n")
              :unnarrowed t)))
      
            ;;   ("y" "yank" plain (function org-roam--capture-get-point)
            ;;   "%?"
            ;;   :if-new "%(format-time-string \"%Y-%m-%d--%H-%M-%SZ--${slug}\" (current-time) t)"
            ;;   :head "#+title: ${title}\n#+roam_alias: \n#+roam_tags: \n%c\n"
            ;;   :unnarrowed t)
    ...
    #+RESULTS:
    | d | default | plain | %? | :if-new | (file+head %(format-time-string "%Y-%m-%d--%H-%M-%SZ--${slug}" (current-time) t) #+title: ${title} |
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key global-map (kbd "C-c n b") 'org-roam-buffer)
  ...
  (define-key global-map (kbd "C-c n d") 'org-roam-dailies-find-today)
  (define-key global-map (kbd "C-c n y") 'org-roam-dailies-find-yesterday)
  (define-key global-map (kbd "C-c n i") 'org-roam-node-insert)
  (define-key global-map (kbd "C-c C-j") 'counsel-org-goto)
