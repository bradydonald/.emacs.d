* Package management
  ...
  Let's use =use-package= for package loading because it's super
  nice. The following is an exmple of how to typically configure a
  package. 
...
* Page Break Lines
  ...
  Displays horizontal line for ctrl-L characters
...
* Dired Mode
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (define-key dired-mode-map (kbd "C-<return>") 'xah-xah-open-in-external-app)
...
* TODO Projectile
  :LOGBOOK:
  - Note taken on [2022-01-30 Sun 07:51] \\
    Needs fixing. The switch project command is not working.
  :END:
  #+BEGIN_SRC emacs-lisp
  ...
  #+RESULTS:
  : #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25124 55426 888246 516000) :init (25124 55426 888168 341000) :init-secs (0 0 14731 133000) :use-package-secs (0 0 14936 709000) :config (25124 55426 888155 740000) :config-secs (0 0 14691 982000)))
...
** Org File Locations
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defun db/org-agenda-files ()
       ...
       (setq ofiles (directory-files-recursively "~/OrgDocuments" "org$"))
       ;; some may be encrypted though
       (setq gfiles (directory-files-recursively "~/OrgDocuments" "org.gpg$"))
