...
* Dired Mode
  ...
  #+RESULTS:
  : (keymap (63 . dired-rename-file) (119 . db/wsl-open-in-external-app) (46 . dired-omit-mode) (102 . find-name-dired))
...
* Chat GPT Integration as a Shell
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (db/add-to-load-path "~/.emacs.d/lisp/chatgpt-shell" t '(chatgpt-shell))
