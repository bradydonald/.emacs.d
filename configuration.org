...
* Personal Details Setup
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq user-full-name "Donald Brady" user-mail-address "d@donaldbrady.info")
...
#+begin_src emacs-lisp
  (setq mu4e-contexts
     `( ,(make-mu4e-context
       :name "O365"
       :enter-func (lambda () (mu4e-message "Entering O365 context"))
           :leave-func (lambda () (mu4e-message "Leaving O365 Context"))
       ;; we match based on the contact-fields of the message
       :match-func (lambda (msg)
             (when msg
               (mu4e-message-contact-field-matches msg
                 :to "d@donaldbrady.info")))
       :vars '( ( user-mail-address	    . "d@donaldbrady.info"  )
            ( user-full-name	    . "Donald Brady" )
            ( mu4e-compose-signature .
              (concat
                "Donald Brady\n"
                "e: d@donaldbrady.info\n"))))))
  ...
  #+begin_src emacs-lisp
    (use-package org2blog
      ...
      (setq org2blog/wp-blog-alist
            '(("wordpress"
               :url "https://donaldbrady.info/xmlrpc.php"
               :username "d@donaldbrady.info")))
