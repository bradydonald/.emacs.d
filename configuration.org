   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq org-super-agenda-groups
           '((:name "Today" :time-grid t :scheduled today)
             ...
             (:name "Quick Picks" :effort< "0:15" :order 2)
             (:name "With Caden" :property ("OWNER" "caden") :order 4)
             (:name "Nice" :and (:priority<= "B" :scheduled future) :order 6)
             (:name "Inflight Projects" :and (:heading-regexp "PROJECT" :todo "STARTED") :order 9)
             (:name "Habits" :habit)))
