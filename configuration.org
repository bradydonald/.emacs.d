...
** Task Handling and Agenda
   ...
   | :todo       | (EVENT INFO TO-READ CHECK TO-WATCH WATCHING) | :order     |       9 |       |       |
   | :priority<= | B                                            | :order     |       1 |       |       |
...
* Org Habit Stats
  ...
  #+BEGIN_SRC emacs-lisp
    ;; if it is installed
    (if (file-directory-p "~/.emacs.d/lisp/org-habit-stats")
        (progn
          (add-to-list 'load-path "~/.emacs.d/lisp/org-habit-stats")
...
* Chat GPT Integration
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (if (and (file-directory-p "~/.emacs.d/lisp/org-ai") db/org-ai)
        (use-package org-ai
  ...
  #+RESULTS:
  : #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25625 3471 204582 145000) :init (25625 3471 204575 563000) :init-secs (0 0 280 354000) :use-package-secs (0 4 145780 257000) :config (25625 3471 204543 263000) :config-secs (0 0 229 259000)))
