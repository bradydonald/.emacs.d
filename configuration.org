...
*** Allow the co-existence of work and persoinal contexts under one OrgDocuments directory
    ...
    #+BEGIN_SRC elisp
      (defun db/org-work-context ()
        ...
        (setq org-agenda-files (directory-files-recursively org-directory "org$"))
        (setq org-default-notes-file (concat org-directory "/dcllp/index.org"))
